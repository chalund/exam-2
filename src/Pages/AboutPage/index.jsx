...
const AboutPage = () => {
  return (
    <div className='max-w-screen-md mx-auto'>
      <h1 className="text-center text-xl text-violet-600 uppercase mt-4">About</h1>
      <div className='sm:p-2'>
        <div className='py-4'>
          <p className='mb-3'>Welcome to Holidaze, your ultimate destination for hassle-free travel booking and unforgettable experiences!</p>
          <p className='mb-3'>At Holidaze, we believe that every journey should be filled with excitement, relaxation, and discovery. That's why we're dedicated to providing our customers with the easiest, most enjoyable booking experience possible. Whether you're planning a spontaneous getaway or a meticulously planned vacation, Holidaze is here to make it happen.</p>
        </div>
        ...
        <div className='py-4'>
          <div className='mb-3'>
            <p className='text-violet-600 font-semibold'>Discover New Destinations</p>
          ...
          <div className='mb-3'>
            <p className='text-violet-600 font-semibold'>Seamless Booking</p>
          ...
          <div className='mb-3'>
            <p className='text-violet-600 font-semibold'>Unforgettable Experiences</p>
          ...
          <div className='mb-3'>
            <p className='text-violet-600 font-semibold'>Your Adventure Awaits</p>
        ...
        <p className='py-4'>At Holidaze, we're more than just a booking site – we're your trusted partner in travel, dedicated to making your vacation dreams a reality. Join us and discover a world of endless possibilities. Let's make every day a holiday with Holidaze.</p>
